        ...
        <h2 className="text-xl font-bold mt-12 mb-4 text-center">L'école</h2>
            <div id="epitech" className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                <div className="p-8 sm:p-10 lg:flex-auto">
                    ...
                    Le Programme Grande École d’Epitech est le parcours d’excellence pour votre future carrière d’expert informatique dans la Tech. Il se déroule en 5 ans après le Bac et est accessible hors Parcoursup à tous les candidats niveaux Bac, sur présentation d’un dossier de candidature. Le contenu de ce cursus constitué de près de 80 projets permet l’acquisition de très solides compétences dans tous les champs de l’informatique.                    </p>
                    <div className="mt-10 flex items-center gap-x-4">
                    <h4 className="flex-none text-sm font-semibold leading-6 text-indigo-600">Les points forts</h4>
...
<div className="flex-grow rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
            ...
            <div id="unical" className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-8 sm:p-10 lg:flex-auto">
                <h3 className="text-2xl font-bold tracking-tight text-gray-900">Lifetime membership</h3>
                <p className="mt-6 text-base leading-7 text-gray-600">
                Lorem ipsum dolor sit amet consect etur adipisicing elit. Itaque amet indis perferendis blanditiis
